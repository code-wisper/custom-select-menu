...
//Array of all Countries of the World
let countries = [
  "Afghanistan",
  "Akrotiri",
  "Albania",
...
function addCountry(selectedCountry) {
  ...
  countries.forEach((country) => {
    //if selected value and country value are the same, add selected class
    let isSelected = country == selectedCountry ? "selected" : "";
    //Add all countries inside li tag and then add li inside options tag
...
searchInput.addEventListener("keyup", () => {
  ...
  //return all arrays searched by the user and mapping the returned values with li and joining them
  arr = countries
    .filter((data) => {
